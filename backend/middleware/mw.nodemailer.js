...
const sendResetPassword = async (username, email) => {
...
const sendUserCreatedConfirmation = async (username, email) => {
...
module.exports = { sendResetPassword, sendUserCreatedConfirmation };