...
class ComposerView extends React.Component {
  constructor(props) {
    ...
    this.refreshFilmFeed = this.refreshFilmFeed.bind(this);
  ...
  render () {
    ...
    let refreshFilmFeed = this.refreshFilmFeed;
    let rightPanel;
      ...
      <div id="composer-view">
        <div id="all-films-wrapper">
          <div id="film-feed-title">
            <span onClick={refreshFilmFeed}>Film Feed</span>
          </div>
          <FilmsDisplay
            allFilms={allFilms}
